...
export class ProductsListComponent implements OnInit {
  ...
  onSubmitFilter(): void {
    ...
    const form = {
      ...
      lineId: this.sf.productLines_list.value
        ? this.sf.productLines_list.value
        : 0,
      productName: this.sf.productName.value,
      customerProductCode: this.sf.customerCode.value,
      sizes: this.sf.size.value,
      brandCatalogId: 0,
      customerId:
        this.storageService.getGrup() == null
          ? null
          : this.storageService.getGrup(),
      creationDate: this.sf.date.value
        ? moment(this.sf.date.value, formatOne).format('YYYY-MM-DD')
        : null,
    };
