import {
    ...
    Input, Output, EventEmitter, ElementRef, ContentChildren, TemplateRef, QueryList, ViewChild, NgZone, ChangeDetectorRef, OnChanges, SimpleChanges, ChangeDetectionStrategy, Query, ViewEncapsulation, Renderer2
} from '@angular/core';
...
import { BlockableUI, FilterMatchMode, FilterMetadata, FilterOperator, FilterService, OverlayService, PrimeNGConfig, PrimeTemplate, SelectItem, SharedModule, SortMeta, TableState, TranslationKeys } from '../api/public_api';
import { UniqueComponentId } from '../utils/uniquecomponentid';
import { ObjectUtils, ZIndexUtils } from '../utils/public_api';
import { ConnectedOverlayScrollHandler, DomHandler } from '../dom/public_api';
import { PaginatorModule } from '../paginator/public_api';
import { InputTextModule } from '../inputtext/public_api';
import { DropdownModule } from '../dropdown/public_api';
import { ButtonModule } from '../button/public_api';
import { SelectButtonModule } from '../selectbutton/public_api';
import { CalendarModule } from '../calendar/public_api';
import { InputNumberModule } from '../inputnumber/public_api';
import { TriStateCheckboxModule } from '../tristatecheckbox/public_api';
...
export class Table implements OnInit, AfterViewInit, AfterContentInit, BlockableUI, OnChanges {
    ...
    isRowExpanded(rowData: any): boolean {
        return this.expandedRowKeys[String(ObjectUtils.resolveFieldData(rowData.value, this.dataKey))] === true;
    }
...
export class TableModuleFinotex { }
