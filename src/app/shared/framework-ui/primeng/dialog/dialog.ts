...
import { Footer, Header, PrimeNGConfig, PrimeTemplate, SharedModule } from '../api/public_api';
import { UniqueComponentId } from '../utils/uniquecomponentid';
import { DomHandler } from '../dom/public_api';
import { ZIndexUtils } from '../utils/public_api';
import { FocusTrapModule } from '../focustrap/public_api';
        ...
        <div *ngIf="maskVisible" [class]="maskStyleClass"
            ...
            <div #container [ngClass]="{'p-dialog p-component':true, 'p-dialog-rtl':rtl,'p-dialog-draggable':draggable,'p-dialog-resizable':resizable, 'p-dialog-maximized': maximized}"
                ...
                <div #titlebar class="p-dialog-header" (mousedown)="initDrag($event)" *ngIf="showHeader">
                    <span [attr.id]="id + '-label'" class="p-dialog-title ttile-page" *ngIf="!headerFacet && !headerTemplate">{{header}}</span>
                    ...
                    <div class="p-dialog-header-icons">
                        ...
                        <button *ngIf="closable" class="close" type="button" [ngClass]="{'p-dialog-header-icon p-dialog-header-close p-link':true}" [attr.aria-label]="closeAriaLabel" (click)="close($event)" (keydown.enter)="close($event)" [attr.tabindex]="closeTabindex" pRipple>
